...
const CommunityItems: CommunityItemType[] = [
  {
    img: "assets_home/images/community-img1.png",
    name: "Jane Smith",
  ...
  {
    img: "assets_home/images/community-img3.png",
    name: "Olivia Amelia",
  ...
  {
    img: "assets_home/images/community-img2.png",
...
const Community = () => {
  ...
  return (
    <div className="flex flex-col w-full md:items-center relative pt-[70px] pb-[50px]">
      <img
        src="assets_home/images/bg-ellipse.png"
        alt=""
        className="absolute top-0 left-[50%] translate-x-[-50%] hidden md:flex"
      />
      <img
        src="assets_home/images/cmnt-circle-color-left.png"
        alt=""
        className="absolute top-[6%] left-[20%] translate-x-[-20%] hidden md:flex"
      />
      <img
        src="assets_home/images/cmnt-circle-color-right.png"
        alt=""

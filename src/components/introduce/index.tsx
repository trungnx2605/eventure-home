import { VoiceIcon } from "../../default/icons";
  ...
  return (
    <div className="flex flex-col items-center pt-32 pb-16 bg-neutral md:px-16 relative overflow-hidden">
      ...
      <div className="inline flex-wrap text-center eventure-headline-3 md:eventure-headline-1 text-[white] px-5 w-screen max-w-screen md:max-w-[1030px] relative z-10">
        <p className="ml-4 inline">Virtually</p>
        <div className="relative inline">
          <span className="text-gradient bg-gradient-primary ml-8 ">real</span>
          <VoiceIcon
            width={30}
            height={30}
        ...
        <p className="ml-4 inline">connection</p>
      </div>
      ...
      <div className="relative z-10 lg:min-h-[50vh] md:min-h-[40vh] min-h-[20vh]">
        <img loading="lazy" src="assets_home/images/introduce-img.png" alt="" />
      </div>
    </div>
  );
};
